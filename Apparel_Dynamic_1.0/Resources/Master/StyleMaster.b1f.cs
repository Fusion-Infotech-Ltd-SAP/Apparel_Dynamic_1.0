...
{
    [FormAttribute("FIL_FRM_STYLMSTR", "Resources/Master/StyleMaster.b1f")]
    class StyleMaster : UserFormBase
    {
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.MTXSBCLR.ClickAfter += new SAPbouiCOM._IMatrixEvents_ClickAfterEventHandler(this.MTXSBCLR_ClickAfter);
        ...
        private void MTXCOLOR_ClickAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item(pVal.FormUID);
            oForm.PaneLevel = 2;
            FormSettingsHelper.Enable(oForm, "MTXCOLOR");

        }

        private void MTXSBCLR_ClickAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item(pVal.FormUID);
            oForm.PaneLevel = 2;
            FormSettingsHelper.Enable(oForm, "MTXSBCLR");

        }

        private void FOLITEM_ClickAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item(pVal.FormUID);
            ...
            try
            {
                ...
                oForm.PaneLevel = 3;
                FormSettingsHelper.Enable(oForm, "MTXITEM");
            }
            catch (Exception ex)
            {
                Global.GFunc.ShowError("Failed to load Item tab: " + ex.Message);
            }
            finally
            {
                oForm.Freeze(false);
        ...
        private void FOLATTAC_ClickAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item(pVal.FormUID);
            oForm.PaneLevel = 4;
            FormSettingsHelper.Enable(oForm, "MTXATTCH");
        }
        private void FOLSIZE_ClickAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item(pVal.FormUID);
            oForm.PaneLevel = 1;
        ...
        private void Form_DataLoadAfter(ref SAPbouiCOM.BusinessObjectInfo pVal)
        {
            ...
            try
            {
                ...
                Global.GFunc.SetItemsEnabled(oForm, false, "ETSLCODE", "ETGENAME", "ETPDGPNM", "ETPDTPNM", "ETPDLNNM",
                ...
                if (sampleBase == "Y")
                {
                    Global.GFunc.SetItemsEnabled(oForm, true, "ETSMPLCD");
                }
                else
                {
                    Global.GFunc.SetItemsEnabled(oForm, false, "ETSMPLCD");
                }
        ...
        private void CBSMPBSE_ComboSelectAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            ...
            try
            {
                ...
                SAPbouiCOM.EditText oETUOM = (SAPbouiCOM.EditText)oForm.Items.Item("ETUOM").Specific;

                string value = oCombo.Value.Trim();

                if (value == "Y")
                {
                    Global.GFunc.ShowWarning("Style is Based On Sample Master");
                    ...
                    Global.GFunc.SetItemsEnabled(oForm, false, "ETUOM");
                    oETUOM.Value = "";
                }
                else if (value == "N")
                {
                    ...
                    Global.GFunc.SetItemsEnabled(oForm, true, "ETUOM");
                }
            }
            catch (Exception ex)
            {
        ...
        private void ETSMPLCD_ChooseFromListAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                ...
                SAPbouiCOM.EditText ETUOM = (SAPbouiCOM.EditText)oForm.Items.Item("ETUOM").Specific;
                ETUOM.Value = Uom;
            }
            catch (Exception ex)
            {
